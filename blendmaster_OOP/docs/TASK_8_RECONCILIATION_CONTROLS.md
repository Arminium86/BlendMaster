...
The subsequent [source-matching clarification](RECONCILIATION_EVIDENCE_MATCH.md)
renames the visible metric to Evidence match score and removes uncertainty.
